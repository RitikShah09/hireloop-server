...
exports.getCandidateFullProfile = exports.getSuggestedJobs = exports.deleteMilestone = exports.updateMilestone = exports.addMilestone = exports.getMilestones = exports.deleteEducation = exports.updateEducation = exports.addEducation = exports.getEducations = exports.deleteWorkExperience = exports.updateWorkExperience = exports.addWorkExperience = exports.getWorkExperiences = exports.deleteCertification = exports.updateCertification = exports.addCertification = exports.getCertifications = void 0;
...
const updateCertification = async (candidateId, certId, data) => {
    ...
    if (!cert)
        throw new errors_1.AppError('Certification not found', 404);
...
const updateWorkExperience = async (candidateId, expId, data) => {
    ...
    if (!exp)
        throw new errors_1.AppError('Work experience not found', 404);
...
const updateEducation = async (candidateId, eduId, data) => {
    ...
    if (!edu)
        throw new errors_1.AppError('Education not found', 404);
...
const getSuggestedJobs = async (candidateId) => {
    ...
    const scored = jobs.map((job) => {
        const matches = job.skills.filter((s) => candidate.skills.includes(s)).length;
