export declare const sendEmailVerificationOtp: (userId: string, email: string) => Promise<void>;
export declare const verifyEmailOtp: (userId: string, otp: string) => Promise<void>;
