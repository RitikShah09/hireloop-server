...
exports.enhanceResumeSection =
  exports.aiJobSearch =
  exports.buildResumeFromUpload =
  exports.buildResumeFromScratch =
  exports.chatWithCandidatePool =
  exports.generatePersonalizedEmail =
  exports.screenResume =
    void 0;
...
Example output:
{
  ...
  try {
    ...
    logger_1.logger.debug(
      `Gemini screening raw response: ${raw.slice(0, 200)}`
    );
    ...
    logger_1.logger.error(
      'This is usually a JSON parsing issue with Gemini response'
    );
    return {
      score: 50,
      summary:
