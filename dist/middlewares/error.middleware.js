...
const errorHandler = (err, req, res, _next) => {
    ...
    if (err instanceof zod_1.ZodError) {
        (0, response_1.sendError)(res, 'Validation failed', 422, (0, validate_middleware_1.formatZodErrors)(err.issues));
        return;
    }
...
const notFound = (req, res) => {
    (0, response_1.sendError)(res, `Route ${req.method} ${req.url} not found`, 404);
};
