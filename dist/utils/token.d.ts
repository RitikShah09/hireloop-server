...
export declare const isAccessTokenBlacklisted: (
  jti: string
) => Promise<boolean>;
export declare const isRefreshTokenBlacklisted: (
  token: string
) => Promise<boolean>;
export declare const storeSession: (
  sessionId: string,
  userId: string,
  meta: {
    userAgent?: string;
...
export declare const invalidateSession: (
  sessionId: string,
  userId: string
) => Promise<void>;
