...
exports.deactivateQuiz =
  exports.submitQuiz =
  exports.startQuiz =
  exports.getQuizAttempts =
  exports.getQuizByJob =
  exports.createQuiz =
    void 0;
...
exports.createQuiz = (0, errors_1.asyncHandler)(async (req, res) => {
  ...
  if (existing)
    throw new errors_1.AppError(
      'Quiz already exists for this job. Deactivate the existing one first.',
      409
    );
...
exports.getQuizByJob = (0, errors_1.asyncHandler)(async (req, res) => {
  ...
  if (!quiz) throw new errors_1.AppError('No active quiz for this job', 404);
  if (user.role === 'CANDIDATE') {
    ...
    (0, response_1.sendSuccess)(res, 'Quiz fetched', {
      ...
      questions:
        attempt?.status === 'COMPLETED' ? quiz.questions : safeQuestions,
...
exports.submitQuiz = (0, errors_1.asyncHandler)(async (req, res) => {
  ...
  if (!quiz) throw new errors_1.AppError('Quiz not found', 404);
  const attempt = await prisma_1.default.quizAttempt.findUnique({
    where: {
      quizId_candidateId: { quizId: quiz.id, candidateId: candidate.id },
    },
  ...
  const { score, correct, total, results } = quizService.scoreQuizAttempt(
    questions,
    answers
  );
