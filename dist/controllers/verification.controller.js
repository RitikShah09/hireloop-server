...
exports.resetPassword = exports.forgotPassword = exports.verifyEmail = exports.sendOtp = void 0;
...
exports.sendOtp = (0, errors_1.asyncHandler)(async (req, res) => {
    const user = req.user;
    const dbUser = await prisma_1.default.user.findUnique({ where: { id: user.userId } });
    if (!dbUser)
...
exports.verifyEmail = (0, errors_1.asyncHandler)(async (req, res) => {
    ...
    const { otp } = req.body;
    if (!otp)
        throw new errors_1.AppError('OTP is required', 400);
...
exports.forgotPassword = (0, errors_1.asyncHandler)(async (req, res) => {
    ...
    (0, response_1.sendSuccess)(res, 'If an account exists, a reset OTP has been sent');
});
exports.resetPassword = (0, errors_1.asyncHandler)(async (req, res) => {
    ...
    (0, response_1.sendSuccess)(res, 'Password reset successfully. Please login.');
});
