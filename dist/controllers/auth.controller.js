...
exports.changePassword = exports.me = exports.revokeSession = exports.getSessions = exports.logout = exports.refresh = exports.login = exports.register = void 0;
...
exports.register = (0, errors_1.asyncHandler)(async (req, res) => {
    const { body } = (0, validate_middleware_1.parseRequest)(auth_validator_1.registerSchema, req);
    ...
    (0, response_1.sendSuccess)(res, 'Registration successful', { user: result.user }, 201);
});
exports.login = (0, errors_1.asyncHandler)(async (req, res) => {
    const { body } = (0, validate_middleware_1.parseRequest)(auth_validator_1.loginSchema, req);
    const meta = { userAgent: req.headers['user-agent'], ipAddress: req.ip };
...
exports.logout = (0, errors_1.asyncHandler)(async (req, res) => {
    ...
    await authService.logoutUser(user.userId, user.sessionId, user.jti, refreshToken, logoutAll === true);
    res.clearCookie(ACCESS_COOKIE, COOKIE_OPTIONS);
    res.clearCookie(REFRESH_COOKIE, COOKIE_OPTIONS);
    (0, response_1.sendSuccess)(res, logoutAll ? 'Logged out from all devices' : 'Logged out successfully');
});
...
exports.changePassword = (0, errors_1.asyncHandler)(async (req, res) => {
    const user = req.user;
    const { body: { currentPassword, newPassword }, } = (0, validate_middleware_1.parseRequest)(auth_validator_1.changePasswordSchema, req);
