...
exports.deleteReadNotifications = exports.deleteNotification = exports.markAllAsRead = exports.markAsRead = exports.getUnreadCount = exports.getNotifications = exports.streamNotifications = void 0;
...
exports.streamNotifications = (0, errors_1.asyncHandler)(async (req, res) => {
    ...
    res.flushHeaders();
    res.write(`data: ${JSON.stringify({ type: 'connected', userId: user.userId })}\n\n`);
...
exports.getNotifications = (0, errors_1.asyncHandler)(async (req, res) => {
    const user = req.user;
    const result = await notificationService.getNotifications(user.userId, req.query);
...
exports.markAsRead = (0, errors_1.asyncHandler)(async (req, res) => {
    const user = req.user;
    const notification = await notificationService.markAsRead(user.userId, req.params.id);
...
exports.deleteReadNotifications = (0, errors_1.asyncHandler)(async (req, res) => {
    const user = req.user;
